...
<Project Type="Project" LVVersion="20008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="PPL" Type="Folder">
			...
			<Item Name="HDH.Data.Generic.FileIO.TDMS.lvlibp" Type="LVLibp" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp">
				<Item Name="Controls" Type="Folder">
					<Item Name="Ctl_DataType.ctl" Type="VI" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/TDMS Load/Controls/Ctl_DataType.ctl"/>
				</Item>
				<Item Name="Data Classes" Type="Folder">
					<Item Name="Channel.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/TDMS Load/TDMS Channel/Channel.lvclass"/>
					<Item Name="File.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/TDMS Load/TDMS File/File.lvclass"/>
					<Item Name="Group.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/TDMS Load/TDMS Group/Group.lvclass"/>
					<Item Name="Interpret DataType.vi" Type="VI" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/TDMS Load/Interpret DataType.vi"/>
					<Item Name="Populate Attribute Variant.vi" Type="VI" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/TDMS Load/Populate Attribute Variant.vi"/>
				</Item>
				<Item Name="HDH.Data.Generic.FileIO.TDMS_Check if File or Folder Exists.vi" Type="VI" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/1abvi3w/vi.lib/Utility/libraryn.llb/HDH.Data.Generic.FileIO.TDMS_Check if File or Folder Exists.vi"/>
				<Item Name="HDH.Data.Generic.FileIO.TDMS_Error Cluster From Error Code.vi" Type="VI" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/1abvi3w/vi.lib/Utility/error.llb/HDH.Data.Generic.FileIO.TDMS_Error Cluster From Error Code.vi"/>
				<Item Name="HDH.Data.Generic.FileIO.TDMS_NI_FileType.lvlib" Type="Library" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/1abvi3w/vi.lib/Utility/lvfile.llb/HDH.Data.Generic.FileIO.TDMS_NI_FileType.lvlib"/>
				<Item Name="HDH.Data.Generic.FileIO.TDMS_NI_PackedLibraryUtility.lvlib" Type="Library" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/1abvi3w/vi.lib/Utility/LVLibp/HDH.Data.Generic.FileIO.TDMS_NI_PackedLibraryUtility.lvlib"/>
				<Item Name="Load.vi" Type="VI" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/TDMS Load/Load.vi"/>
				<Item Name="Save.vi" Type="VI" URL="../../../../PPL/HDH.Data.Generic.FileIO.TDMS.lvlibp/Save.vi"/>
			</Item>
			<Item Name="HDH.Actor Framework.Core.File Writer.lvlibp" Type="LVLibp" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer.lvlibp">
				<Item Name="File Post Action" Type="Folder">
					<Item Name="File Post Action.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer.lvlibp/File Writer/File Post Action/File Post Action.lvclass"/>
				</Item>
				<Item Name="Messages for this Actor" Type="Folder">
					<Item Name="Utility" Type="Folder">
						<Item Name="Forward To File Writer.vi" Type="VI" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer.lvlibp/File Writer Messages/Utility/Forward To File Writer.vi"/>
					</Item>
					<Item Name="Close File Msg.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer.lvlibp/File Writer Messages/Close File Msg/Close File Msg.lvclass"/>
					<Item Name="Open File Msg.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer.lvlibp/File Writer Messages/Open File Msg/Open File Msg.lvclass"/>
				</Item>
				<Item Name="File Writer.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer.lvlibp/File Writer/File Writer.lvclass"/>
				<Item Name="HDH.Actor Framework.Core.File Writer_Is Path and Not Empty.vi" Type="VI" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer.lvlibp/1abvi3w/vi.lib/Utility/file.llb/HDH.Actor Framework.Core.File Writer_Is Path and Not Empty.vi"/>
			</Item>
			...
			<Item Name="HDH.Actor Framework.Core.Graph.lvlibp" Type="LVLibp" URL="../../../../PPL/HDH.Actor Framework.Core.Graph.lvlibp">
				<Item Name="Graph.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.Graph.lvlibp/Graph/Graph.lvclass"/>
				<Item Name="HDH.Actor Framework.Core.Graph_usereventprio.ctl" Type="VI" URL="../../../../PPL/HDH.Actor Framework.Core.Graph.lvlibp/1abvi3w/vi.lib/event_ctls.llb/HDH.Actor Framework.Core.Graph_usereventprio.ctl"/>
			</Item>
			<Item Name="HDH.Actor Framework.Core.Data Tracker.lvlibp" Type="LVLibp" URL="../../../../PPL/HDH.Actor Framework.Core.Data Tracker.lvlibp">
				<Item Name="Messages for this Actor" Type="Folder">
					<Item Name="Data Tracker Msg" Type="Folder">
						<Item Name="Controls" Type="Folder">
							<Item Name="Ctl_Action.ctl" Type="VI" URL="../../../../PPL/HDH.Actor Framework.Core.Data Tracker.lvlibp/Messages for this Actor/Data Tracker Msg/Controls/Ctl_Action.ctl"/>
						</Item>
						<Item Name="Data" Type="Folder">
							<Item Name="Tracker Data.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.Data Tracker.lvlibp/Data Tracker/Data/Tracker Data.lvclass"/>
						</Item>
						<Item Name="Data Tracker Msg.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.Data Tracker.lvlibp/Messages for this Actor/Data Tracker Msg/Data Tracker Msg.lvclass"/>
					</Item>
				</Item>
				<Item Name="Data Tracker.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.Data Tracker.lvlibp/Data Tracker/Data Tracker.lvclass"/>
				<Item Name="HDH.Actor Framework.Core.Data Tracker_Clear Errors.vi" Type="VI" URL="../../../../PPL/HDH.Actor Framework.Core.Data Tracker.lvlibp/1abvi3w/vi.lib/Utility/error.llb/HDH.Actor Framework.Core.Data Tracker_Clear Errors.vi"/>
			</Item>
			<Item Name="HDH.Actor Framework.Core.Data Repository.lvlibp" Type="LVLibp" URL="../../../../PPL/HDH.Actor Framework.Core.Data Repository.lvlibp">
				<Item Name="Access Data.vi" Type="VI" URL="../../../../PPL/HDH.Actor Framework.Core.Data Repository.lvlibp/Access Data.vi"/>
				<Item Name="Data Repository.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.Data Repository.lvlibp/Data Repository/Data Repository.lvclass"/>
			</Item>
			<Item Name="HDH.Actor Framework.Core.File Writer_TDMS.lvlibp" Type="LVLibp" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer_TDMS.lvlibp">
				<Item Name="File Writer_TDMS.lvclass" Type="LVClass" URL="../../../../PPL/HDH.Actor Framework.Core.File Writer_TDMS.lvlibp/File Writer_TDMS/File Writer_TDMS.lvclass"/>
			</Item>
		</Item>
		<Item Name="Sequencer test.vi" Type="VI" URL="../Sequencer test.vi"/>
		<Item Name="Actor Test.vi" Type="VI" URL="../Actor Test.vi"/>
		<Item Name="Loop wait test.vi" Type="VI" URL="../Loop wait test.vi"/>
		<Item Name="TDMS Write Through Publisher test.vi" Type="VI" URL="../TDMS Write Through Publisher test.vi"/>
